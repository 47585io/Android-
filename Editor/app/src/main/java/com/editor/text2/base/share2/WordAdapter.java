...
public class WordAdapter<T> extends BaseAdapter
{
	...
	public static WordAdapter<wordIcon> getDefultAdapter()
	{
		WordAdapter<wordIcon> adapter = new WordAdapter<>();
	...
	*/
	public static class Factory implements ViewHolderFactory<wordIcon>
	{
		...
		*/
		public class Holder implements ViewHolder<wordIcon>
		{
