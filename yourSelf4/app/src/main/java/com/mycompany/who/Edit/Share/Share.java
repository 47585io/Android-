...
public class Share
{
	...
	public static byte icon_key=1;
	public static byte icon_villber=2;
	public static byte icon_func=3;
	public static byte icon_type=4;
	public static byte icon_tag=5;
	public static byte icon_obj=8;
	public static byte icon_default=-128;
