...
public class Colors
{
	...
	public static void ForeColorText(Editable editor,List<wordIndex> nodes,int start){
		for(wordIndex node:nodes)
	...
	public static void BackColorText(Editable editor,List<wordIndex> nodes,int start){
		for(wordIndex node:nodes)
