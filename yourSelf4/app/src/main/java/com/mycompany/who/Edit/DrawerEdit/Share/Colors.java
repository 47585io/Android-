...
public class Colors
{
	...
	public static byte color_zhu=1;
	public static byte color_str=2;
	public static byte color_fuhao=3;
	public static byte color_number=4;
	public static byte color_key=5;
	public static byte color_const=6;
	public static byte color_villber=7;
	public static byte color_func=8;
	public static byte color_type=9;
	public static byte color_obj=10;
	public static byte color_tag=11;
	public static byte color_attr=12;
	public static byte color_cssid=13;
	public static byte color_csscla=14;
	public static byte color_cssfl=15;
